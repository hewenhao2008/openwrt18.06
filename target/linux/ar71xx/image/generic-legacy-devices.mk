...
define LegacyDevice/miniv2
  DEVICE_TITLE := 9531 miniv2
  DEVICE_PACKAGES := kmod-usb-core kmod-usb2 kmod-usb-storage
endef
LEGACY_DEVICES += miniv2

define LegacyDevice/fullv2
  DEVICE_TITLE := 9531 fullv2
  DEVICE_PACKAGES := kmod-usb-core kmod-usb2 kmod-usb-storage
endef
LEGACY_DEVICES += fullv2

define LegacyDevice/repeater
  DEVICE_TITLE := 9531 repeater
  DEVICE_PACKAGES := kmod-usb-core kmod-usb2 kmod-usb-storage
endef
LEGACY_DEVICES += repeater

define LegacyDevice/db3
  DEVICE_TITLE := 9531 db3
  DEVICE_PACKAGES := kmod-usb-core kmod-usb2 kmod-usb-storage
endef
LEGACY_DEVICES += db3
