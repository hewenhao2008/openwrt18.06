...
miniv2_mtdlayout=mtdparts=spi0.0:128k(u-boot)ro,64k(u-boot-env),128k(config),14528k(rootfs),1472k(kernel),64k(art),16000k@0x50000(firmware)
fullv2_mtdlayout=mtdparts=spi0.0:128k(u-boot)ro,64k(u-boot-env),64k(art),64k(config),14528k(rootfs),1472k(kernel),16064k@0x50000(firmware)
repeater_mtdlayout=mtdparts=spi0.0:128k(u-boot)ro,64k(u-boot-env),64k(art),64k(config),14528k(rootfs),1472k(kernel),16064k@0x50000(firmware)
db3_mtdlayout=mtdparts=spi0.0:128k(u-boot)ro,64k(u-boot-env),128k(config),14528k(rootfs),1472k(kernel),64k(art),16000k@0x50000(firmware)
...
$(eval $(call SingleProfile,AthLzma,64k,miniv2,miniv2,miniv2,ttyS0,115200,$$(miniv2_mtdlayout),RKuImage))
$(eval $(call SingleProfile,AthLzma,64k,fullv2,fullv2,fullv2,ttyS0,115200,$$(fullv2_mtdlayout),RKuImage))
$(eval $(call SingleProfile,AthLzma,64k,repeater,repeater,repeater,ttyS0,115200,$$(repeater_mtdlayout),RKuImage))
$(eval $(call SingleProfile,AthLzma,64k,db3,db3,db3,ttyS0,115200,$$(db3_mtdlayout),RKuImage))
